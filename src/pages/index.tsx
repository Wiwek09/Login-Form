   ...
   <div className='login h-screen w-screen md:h-screen md:min-w-full'>
    <div className='p-6 md:p-10 md:w-[50%]' >
      ...
      <div className='md:pt-32 md:pl-32 md:h-auto pt-10 md:w-[100%] '>
        ...
        <section className='mt-7 h-full w-[60%] lg:w-[50%] md:w-[60%] '>
          <form onSubmit={onSubmit} className='' method="post"  >
            <div className='flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-6 w-full' >
               ...
               <div className='relative h-[6vh] w-full ' >
                 <label className='absolute top-0 translate-x-1 px-2  text-xs text-gray-800' >Last Name</label>
                 <input {...register("lastName",{required:true,pattern: /^[A-Za-z]+$/,maxLength: 20})} id='LastName' className='outline-none border-2 px-2 py-[1.5rem] rounded-md h-[5vh] bg-gray-300 focus:border-blue-400 pr-10 w-full' type={"text"}/>
                 {
            ...
            <div className='mt-10  flex flex-col gap-5 w-[100%]  md:w-full ' >
               <div className='relative h-[6vh]' >
                 <label className='absolute top-0 px-2  translate-x-1 text-xs text-gray-800' >Email</label>
                 <input {...register("email",{required:true,pattern: /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/})} id='email' className='outline-none h-[5vh] px-2 py-[1.5rem] w-full border-2 rounded-md  bg-gray-300 focus:border-blue-400 pr-9' type={"text"}/>
                 {
                 ...
                 <MdOutlineMessage className='text-xl absolute md:w-[50%] w-[90%] top-1/2 right-6 translate-x-24 -translate-y-1/2 '/>
               </div>
               <div className='relative h-[6vh] mt-2 ' >
                 <label className='absolute top-0 px-2  translate-x-1 text-xs text-gray-800' >Password</label>
                 ...
                 <div className='text-xl absolute md:w-[28%] w-[50%] top-1/2 right-6 translate-x-24 -translate-y-1/2 cursor-pointer' onClick={toggle} >
