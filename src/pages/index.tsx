  ...
  <Head><title>My Next App</title></Head>  
   <div className='login h-screen w-screen md:h-screen md:min-w-full'>
    <div className='p-6 md:p-10 md:w-[50%] ' >
      ...
      <div className='md:pt-32 md:pl-32 md:h-auto pt-10 '>
        ...
        <section className='mt-7 h-full'>
          <form onSubmit={onSubmit} className='w-[50%]' method="post"  >
            <div className='md:flex md:gap-6 w-full ' >
               <div className='relative h-[6vh]' >  
                 ...
                 <input {...register("firstName",{required:true,pattern: /^[A-Za-z]+$/, maxLength: 20})} id='firstName' className='outline-none px-2 py-[1.5rem] border-2 rounded-md text-justify h-[5vh]  focus:border-blue-400 bg-gray-300 pr-10' type={"text"} />
                 {
               ...
               <div className='relative h-[6vh]' >
                 ...
                 <input {...register("lastName",{required:true,pattern: /^[A-Za-z]+$/})} id='LastName' className='outline-none border-2 px-2 py-[1.5rem] rounded-md h-[5vh] bg-gray-300 focus:border-blue-400 pr-10' type={"text"}/>
                 {
